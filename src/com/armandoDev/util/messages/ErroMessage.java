...
public class ErroMessage extends javax.swing.JDialog {
    ...
    public ErroMessage(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    public ErroMessage(JFrame parent, boolean modal, String message) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        rSPanelImage2.setImagen(new javax.swing.ImageIcon(getClass().getResource("/com/armandoDev/images/messages/erro.png"))); // NOI18N
        ...
        jLabel1.setText("Erro do Sistema");
